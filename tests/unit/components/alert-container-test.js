...
module('Unit | Component | alert-container', function(hooks) {
  setupTest(hooks);
  ...
  hooks.beforeEach(function() {
      ...
      component = this.owner.factoryFor('component:alert-container').create({ alerter });

      this.owner.register('component:alert-item', inner);
  });
